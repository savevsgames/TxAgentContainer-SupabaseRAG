...
a complete treatment entry can be saved. Enhanced with flexibility features.
"""
...
class TreatmentTracker:
    """Manages conversational treatment tracking with incremental data collection and enhanced flexibility."""
    ...
    def start_treatment_tracking(self, user_id: str, initial_query: str) -> Dict[str, Any]:
        """Start a new treatment tracking session with intelligent question skipping."""
    ...
    def update_treatment_data(self, session_id: str, user_response: str) -> Dict[str, Any]:
        """Update treatment data based on user response with intelligent extraction."""
    ...
    def _extract_initial_data(self, query: str) -> Dict[str, Any]:
        """Extract initial treatment data from user's query with enhanced extraction."""
        data = {}
    ...
    def cancel_session(self, session_id: str) -> Dict[str, Any]:
        ...
        if session_id in self.active_sessions:
            del self.active_sessions[session_id]
            logger.info(f"✅ TREATMENT_TRACKER: Cancelled session {session_id}")
            return {"success": True}
    ...
    def get_session_summary(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            "summary": summary if summary else "No treatment data collected yet.",
            "progress": progress,
            "next_question": next_question
        }
    ...
    def edit_field(self, session_id: str, field_name: str, new_value: Any) -> Dict[str, Any]:
        ...
        # Update the field
        session["treatment_data"][field_name] = new_value
        session["last_updated"] = datetime.now().isoformat()
        
        logger.info(f"✅ TREATMENT_TRACKER: Updated {field_name} to {new_value} in session {session_id}")
